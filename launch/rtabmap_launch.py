...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # imu
        DeclareLaunchArgument('imu_topic',        default_value='/imu_sensor_controller/imu ', description='Used with VIO approaches and for SLAM graph optimization (gravity constraints).'),
